...
本图鉴已经很老了、有年头了。图鉴持有者毕业并离开该领域也已经很久。若有此处登录的某道题目答案无法通过该题目，由于年代久远，是可能发生的。相关代码仅供参考。
...
如果您在此处的图鉴没有查阅到想要的题目答案，欢迎去隔壁GoatGirl98学长的图鉴（C++的样子）那里逛逛。

但学长那里也有可能看不到。因为学长比我还老。后续的题目缺失是极为正常的。如果您很感兴趣，也可以自行建立一个代码库，并记录更多东西。当您建立新代码库时，本仓库的代码可以随意使用并修改。

### 关于图鉴的主人

我年少时很喜欢数学，但后来没有从事相关行业，后续转码，然后学得很费劲。

虽然终于学会了写代码，但是我终究不能继续从事代码相关的行业。人生的道路是需要继续往后走的。一路颠沛流离，我也不知道未来会走到哪里，见到什么。

我仍旧需要就业，需要结婚生子，需要养育下一代。这些代码对于我而言，已经早就没有用了。

老人们终将逝去，我也会成为历史的尘埃。即使一路干到了榜一，又有什么用呢？此类仓库只是一个路标，不应成为天花板，应当鼓励更多人去超越它。

我不知道 OJ4th 终究能开多久，也许某年就关，也许开到下个世纪。这个图鉴已然是一个古物，一种纪念品。虽然有些老了，但目前应该还能用。

或许未来我的孩子到了学习代码的年纪，他们这一辈还会看到这里，或者能看到更好的代码仓库。
...
缺失题目列表是图鉴持有者2022年时可以观测到，而图鉴里暂缺答案的题目。由于年代久远，OJ后面还会更新其他的新题目。如果您感兴趣，也可以把后续题解提供至这里。
