...
int n, m, uni, a[10005], block, A[10005], L = 1, R;
long long _l[10005], _r[10005], b[10005], ec[10005], cnt[10005];

int getposition( int i)
{
	return (i - 1) / block + 1;    // 所在的块
}
...
vector<vnode> __l[10005], __r[10005];
